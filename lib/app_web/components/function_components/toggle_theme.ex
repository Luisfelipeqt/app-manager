defmodule AppWeb.FunctionComponents.ToggleTheme do
  ...
  def toggle_theme(assigns) do
    ...
    <button
      ...
      class="bg-white flex h-9 w-9 items-center justify-center rounded-lg shadow-md shadow-black/5 ring-1 ring-black/5 backdrop-blur transition dark:bg-slate-700 dark:ring-inset dark:ring-white/5"
    >
      <svg
        id="theme-toggle-dark-icon"
        class="w-5 h-5 fill-sky-400 hidden text-transparent"
        fill="currentColor"
        viewBox="0 0 20 20"
